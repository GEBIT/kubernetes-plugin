...
public class KubernetesCloudLimiterTest {
    ...
    public void testIncPending() throws IOException, UnrecoverableKeyException, CertificateEncodingException, NoSuchAlgorithmException, KeyStoreException {
        ...
        // must be 64Mi from config map + 8Gi (= 8192Mi) from first container and + 4G (= 3814Mi) from second container = 8000m
    ...
    @Test
    public void testGetAllocatableMemMi() throws IOException, UnrecoverableKeyException, CertificateEncodingException, NoSuchAlgorithmException, KeyStoreException, InterruptedException {
        KubernetesCloud cloud = new KubernetesCloud("name") {
            @Override
            public KubernetesClient connect() throws UnrecoverableKeyException, NoSuchAlgorithmException, KeyStoreException, IOException, CertificateEncodingException {
                KubernetesClient mockClient =  Mockito.mock(KubernetesClient.class);
    ...
    @Test
    public void testGetUsedMemMi() throws IOException, UnrecoverableKeyException, CertificateEncodingException, NoSuchAlgorithmException, KeyStoreException, InterruptedException {
        KubernetesCloud cloud = new KubernetesCloud("name") {
            @Override
            public KubernetesClient connect() throws UnrecoverableKeyException, NoSuchAlgorithmException, KeyStoreException, IOException, CertificateEncodingException {
              KubernetesClient mockClient =  Mockito.mock(KubernetesClient.class);
    ...
    @Test
    public void testEstimateNumSchedulablePods() throws IOException, UnrecoverableKeyException, CertificateEncodingException, NoSuchAlgorithmException, KeyStoreException, InterruptedException, ANTLRException {
        ConfigMap cm = createTestConfigMap(true, 0, 64);
